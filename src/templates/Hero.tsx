      ...
      <Background color="#0099ff">
        ...
        <Section yPadding="pt-20">
          <HeroOneButton
            ...
            description="Descubre y analiza las mejores opciones para invertir en México"
            button={
              <Link href="form">
                <a>
                    <button className='cursor-pointer bg-white rounded-md inline-block text-blue-500 font-extrabold text-xl py-4 px-6 hover:bg-blue-500 hover:border-1 hover:border-white hover:text-white transition-all duration-300'>Ingresa gratis aquí</button>
